class CompleteDetailsModel {
  ...
  factory CompleteDetailsModel.fromJson(Map<String, dynamic> json) {
    return CompleteDetailsModel(
      id: json['_id'] ?? '',
...
class Payment {
  ...
  factory Payment.fromJson(dynamic json) {
    // Since "payment" can be null in your JSON
