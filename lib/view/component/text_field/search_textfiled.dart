...
Widget searchTextField(
  ...
  String? searchText, // nullable without default
}) {
  final hintText = searchText ?? AppString.searchAddressCityLocation;
  ...
  return TextFormField(
    ...
    decoration: InputDecoration(
      filled: true,
      fillColor: AppColors.searchFieldColor,
      hintText: hintText.tr, // Use the final value
      hintStyle: TextStyle(color: Colors.grey[700]),
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(30),
        borderSide: const BorderSide(color: AppColors.borderColor),
      ...
      prefixIcon: SizedBox(
        height: 20,
        width: 20,
        child: Center(child: CommonImage(imageSrc: AppIcons.searchIcon)),
      ),
