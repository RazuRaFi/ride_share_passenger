...
class SetLocationOffice extends StatefulWidget {
  const SetLocationOffice({super.key});

  @override
  State<SetLocationOffice> createState() => _SetLocationHomeState();
}
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 16,),
                      CommonButton(titleText: "Confirm Office Address",backgroundColor: Colors.black,titleColor: Colors.white,buttonHeight: 56,buttonWidth: 359,titleSize: 16,titleWeight: FontWeight.w500,),
                    ],
                  ),
                ),
